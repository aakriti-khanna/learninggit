...
app.get('/deletetask', (req, res) => {
    // req.query se hm naam lenge activity ka jo array mai hai
    const { task } = req.query;
    // static wale mai check krenge
    // datahelper  to do list pr lekr jaayega
    Todo.deleteTask(task)
        ...
        //  @s above wali thing jo hai data front end mai bhejegi  
        // script.js mai ye same data---> 
})
